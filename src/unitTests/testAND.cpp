...
void test_AND(MOS6502 &cpu)
{
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Immediate: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Zero Page: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Zero Page X: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else {
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Absolute: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Absolute X: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
    ...
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Absolute Y: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
    ...
    cpu._memory[0xFFFC]._value = 0x00;
    cpu._memory[0xFFFD]._value = 0x10;
    cpu._memory[0x1000]._value = 0x21;
    ...
    if ((cyclesUsed = cpu.execute(6)) != 0)
        std::cerr << "FAILURE: AND Indirect X cycles Used: " << cyclesUsed << " != 0" << std::endl;
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Indirect X: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
        std::cout << "SUCCESS: AND Indirect X: " << (int) cpu._a._value << std::endl;
    cpu.clear();
    ...
    cpu._memory[0xFFFC]._value = 0x00;
    cpu._memory[0xFFFD]._value = 0x10;
    cpu._memory[0x1000]._value = 0x31;
    cpu._memory[0x1001]._value = 0x05;
    ...
    if ((cyclesUsed = cpu.execute(5)) != 0)
        std::cerr << "FAILURE: AND Indirect Y cycles Used: " << cyclesUsed << " != 0" << std::endl;
    if (cpu._a._value != 0b00000011) {
        std::cerr << "FAILURE: AND Indirect Y: " << (int) cpu._a._value << " != 0b00000011" << std::endl;
    } else
        std::cout << "SUCCESS: AND Indirect Y: " << (int) cpu._a._value << std::endl;
    cpu.clear();
}